...
- `PREVIEW`: A summarised version of a `SHOW` that only contains basic information. Usually exposed when an array of different `SHOW` information is requested.![Alt text](https://npcmechanicalservices.co.za/wp-content/uploads/2022/11/roodepoort.jpg)
